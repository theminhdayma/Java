...
public class Validator {
    ...
    public static String inputEmployeeId(Scanner sc) {
        String employeeId;
        while (true) {
            ...
            if (!employeeId.matches("^E\\w{4}$")) {
                System.out.println("Mã nhân viên phải có 5 ký tự và bắt đầu bằng 'E'.");
                continue;
            }
            ...
            if (EmployeeUI.employeeService.existEmployeeId(emp)) {
